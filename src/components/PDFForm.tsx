...
export const PDFForm = () => {
  const [formData, setFormData] = useState<PDFData>({
    ...
    branding: 'advant',
    websiteUrl: 'advantailabs.com',
    slides: [
      {
        pageNumber: '02',
        heading: 'The Promise',
        description: "Every second of downtime costs trust and growth.\n\nThat's why at Advant AI Labs, uptime isn't a metric.\n\nIt's a commitment.",
      },
      {
        pageNumber: '03',
        heading: 'The Backbone: DevOps',
        description: 'Our DevOps culture bridges silos between dev and ops, so features ship faster AND stay stable.\n\nContinuous integration + rapid deployment = fewer errors, faster fixes.',
      },
      {
        pageNumber: '04',
        heading: 'Continuous Monitoring',
        description: 'Every app, API, and microservice is monitored in real-time.\n\nReal-time alerts + anomaly detection catch 99% of issues before users ever notice.',
      },
    ],
    ...
    <div className="min-h-screen bg-background py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-4xl font-bold mb-2 text-foreground">PDF Carousel Maker</h1>
          <p className="text-muted-foreground text-lg">Create beautiful presentation-style PDFs</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-2">
            <CardHeader>
              ...
              <CardDescription>Main title and subtitle for your presentation</CardDescription>
            </CardHeader>
                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <CardDescription>Page number: {slide.pageNumber}</CardDescription>
                    </div>
                    <Button
                      variant="ghost"
                      size="icon"
                  ...
                  <div className="grid md:grid-cols-4 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleSlideChange(index, 'pageNumber', e.target.value)}
                        placeholder="02"
                        maxLength={2}
                      />
                    </div>
          ...
          <Card className="border-2">
            <CardHeader>
              ...
              <CardDescription>Final page with your call to action</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
